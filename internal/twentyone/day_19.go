...
func (d *dayNineteen) day19() error {
...
func (d *dayNineteen) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *dayNineteen) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
