...
func (d *daySeven) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *daySeven) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
