...
func (d *daySix) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *daySix) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
