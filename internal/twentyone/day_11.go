...
func (d *dayEleven) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *dayEleven) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
