...
func (d *dayTen) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *dayTen) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
