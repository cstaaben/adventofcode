...
func (d *dayTwentyOne) day21() error {
	conf, err := config.New()
	if err != nil {
...
func (d *dayTwentyOne) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *dayTwentyOne) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
