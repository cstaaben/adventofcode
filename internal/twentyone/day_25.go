...
func (d *dayTwentyFive) day25() error {
	conf, err := config.New()
	if err != nil {
...
func (d *dayTwentyFive) partOne(scanner *bufio.Scanner, logger *log.Logger) {
	logger.Debug("----------> Part One")
}

func (d *dayTwentyFive) partTwo(scanner *bufio.Scanner, logger *log.Logger) {
